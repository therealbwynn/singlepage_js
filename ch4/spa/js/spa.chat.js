...
spa.chat = (function() {
  ...
  // returns true without taking futher action
  // Returns:
  ...
  // Returns : true
  // Throws : Javascript error object and stack trace of
  ...
  // it with HTML content. It then initializes elements, events, and
  // handlers to provide the user with a chat-room interface.
  ...
  // Actions:
  // If the window height or width falls below a given threshold, resize the chat
  // slider for the reduced window size.
  // Returns: Boolean
  ...
  handleResize = function() {
    // dont do anything if we dont have a slider container
