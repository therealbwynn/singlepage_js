...
spa.shell = (function() {
  ...
  // * false - the Anchor portion of ht eURI could not be updated
  // Action :
  ...
  onHashchange = function ( event ) {
    ...
    // End rever anchor if slider change denied
    return false;
  };
  ...
  // The shell is also responsible for browser-wide issues such as
  ...
  initModule = function($container) {
    ...
    // Otherwise, they will not be ready to handle the trigger event, which
